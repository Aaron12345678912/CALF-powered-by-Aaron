...
class Dataset_Solar(Dataset):
    def __init__(self, root_path, flag='train', size=None,
                 features='S', data_path='ETTh1.csv',
                 target='OT', scale=True, timeenc=0, freq='h', seasonal_patterns=None, percent=100, cycle=None):
        # size [seq_len, label_len, pred_len]
        # info
        if size == None:
            self.seq_len = 24 * 4 * 4
        ...
        self.freq = freq
        self.percent = percent
        self.cycle = cycle if (cycle is not None and cycle > 0) else 1
    ...
    def __read_data__(self):
        ...
        # add cycle index for TQ phase synchronization
...
class UEAloader(Dataset):
    ...
    def load_single(self, filepath):
        try:
            ...
            from sktime.utils.data_io import load_from_tsfile_to_dataframe  # type: ignore
